...
@Route(value = "moreInfo" , layout = StudentMainView.class)
@PageTitle("More Info Page")
@CssImport(value = "styles/views/moreInfo.css", include = "lumo-badge")
public class StudentMoreInfoView extends Grid<Event> implements AfterNavigationObserver, BeforeEnterObserver{
    ...
    private void initMonthlyAttendedGraph(){
        ...
        com.vaadin.flow.component.board.Row row = new Row( chart );
        row.setWidthFull();
        row.setHeightFull();
